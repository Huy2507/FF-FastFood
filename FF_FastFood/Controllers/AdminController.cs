...
using static FF_Fastfood.Models.OrderDeliveryViewModel;
    ...
    public class AdminController : Controller
    {
        ...
        public ActionResult Delivery()
        {
            var orders = db.Orders
                .Where(o => o.status == "Waiting" || o.status == "On The Way")
                .Select(o => new OrderDeliveryViewModel
                {
                    OrderId = o.order_id,
        ...
        public ActionResult DeliveryOrderDetail(int id)
        {
            var order = db.Orders
                ...
                .Select(o => new OrderDeliveryViewModel
                {
                    ...
                    PhoneNumber = o.Customer.phone,
                    Status = o.status,
                    OrderItems = o.Order_Items.Select(oi => new OrderItemDeliveryViewModel
                    {
